...
public class CalcNode : BaseInputNode {
    ...
    private CalcutionType calcType;
    public enum CalcutionType {
    ...
    public override void DrawWindow() {
        ...
        calcType = (CalcutionType)EditorGUILayout.EnumPopup("Calculation Type", calcType);
    ...
    public override string getResult() {
        ...
        string result = "false";
        switch(calcType) {
            case CalcutionType.Add:
                result = ( input1Value + input2Value ).ToString();
                break;
            case CalcutionType.Sub:
                result = ( input1Value - input2Value ).ToString();
                break;
            case CalcutionType.Multi:
                result = ( input1Value * input2Value ).ToString();
                break;
            case CalcutionType.Divide:
                result = ( input1Value / input2Value ).ToString();
                break;
        }
        return result;
